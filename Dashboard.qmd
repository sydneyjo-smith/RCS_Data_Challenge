...
output$dynamic_title <- renderUI({
     ...
     # titlePanel(tags$h6(paste("Quarterly Summary -", input$trust_name, ",", input$quarter_year)))
      tags$p(paste("Quarterly Summary (Moving average) -", input$trust_name, ",", input$quarter_year), style = "font-size: 20px;")
