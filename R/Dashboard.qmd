...
plot_1_data<-read_csv("../data/processed_data/plot1.csv")
                  ...
                  columns = list(
                    ...
                    metric_name = colDef(
                      ...
                      cell = function(value, index) {
                        if (plot_1_dataset$RowType[index] == "Header") {
                          return(plot_1_dataset$audit_name_full[index])
                        } else {
                          return(value)
                        }
                      }
                    ...
                    variance = colDef(name="Comparison to National Performance (%)",
                                      cell = function(value, index) {
                                        if (plot_1_dataset$RowType[index] == "Header") {
                                          ...
                                          metric_type <- plot_1_dataset$metric_type[index]
