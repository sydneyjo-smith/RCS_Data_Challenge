    ...
    columns = list(
      ...
      metric_name = colDef(
        ...
        cell = function(value, index) {
          if (data$RowType[index] == "Header") {  # Correct indexing
            return(data$audit_name_full[index])  # Set header row
          } else {
            return(value)
          }
        }
       ...
       denominator = colDef(name="Case Volume",
                                    ...
                                    return(sprintf("%.0f", as.numeric(value)))
                                           }
                                         }
                                      ),
     ...
     variance = colDef(name="Comparison to National Performance (%)",
                  cell = function(value, index) {
                    if (data$RowType[index] == "Header") {
                      ...
                      metric_type <- data$metric_type[index]
